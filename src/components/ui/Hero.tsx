...
export default function Hero() {
  return (
    <section className="relative w-full pt-28 pb-16 flex items-center justify-center px-4 overflow-hidden border-b border-white/5">
      ...
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          <div className="flex items-center gap-2 px-3 py-1.5 mb-6 rounded-full bg-indigo-500/5 border border-indigo-500/20 text-xs font-mono text-indigo-300">
          ...
          <p className="text-base md:text-lg text-gray-400 mb-8 leading-relaxed max-w-xl">
            Full-stack engineer at <strong>VentureSeed (USA)</strong> shipping production features across two B2B SaaS platforms. I build with TypeScript, React, Next.js, Node.js, Python, FastAPI, and PostgreSQL. Currently working remotely from India with distributed international teams.
          </p>
          ...
          <div className="flex flex-wrap gap-3 items-center w-full">
            ...
            <a
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-lg bg-indigo-500/10 text-indigo-300 font-medium border border-indigo-500/30 hover:bg-indigo-500/20 hover:border-indigo-400/40 transition-all hover:scale-[1.02]"
            >
              <FileText size={16} />
              View Resume
            </a>
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 flex items-center justify-center">
            ...
            <div className="relative w-full h-full p-2.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-[0_0_50px_rgba(99,102,241,0.15)] flex items-center justify-center overflow-hidden">
              ...
              <div className="absolute bottom-4 right-4 bg-[#0A0A0B] border border-white/10 px-3 py-1 rounded-full flex items-center gap-1.5 shadow-2xl">
                ...
                <span className="text-[10px] font-mono font-semibold tracking-wider text-emerald-400 uppercase">Available</span>
              </div>
            </div>
          </div>
        </motion.div>
